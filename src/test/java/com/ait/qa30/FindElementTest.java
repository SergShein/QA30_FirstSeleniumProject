...
public class FindElementTest {
    ...
    public void findElementByXpath() {
        ...
        driver.findElement(By.xpath("//*[contains(.,'data and hit Yalla!')]"));   // contains()- можно только половина текста
        driver.findElement(By.xpath("//*[text()='Type your data and hit Yalla!']")); //text() - точный текст
